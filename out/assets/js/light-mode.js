...
function toggleLightMode() {
    ...
    if (newMode) {
        ...
        document.getElementById('toggle-theme-button').innerHTML = '<span class="material-icons">light_mode</span> <span style="font-size: 32px;">|</span> <span class="material-symbols-outlined">dark_mode</span>';
        ...
        document.getElementById('toggle-theme-button').innerHTML = '<span class="material-symbols-outlined">light_mode</span> <span style="font-size: 32px;">|</span> <span class="material-icons">dark_mode</span>';
...
document.getElementById('toggle-theme-button').innerHTML = isLightMode ? '<span class="material-icons" ;">light_mode</span> <span style="font-size: 32px;">|</span> <span class="material-symbols-outlined">dark_mode</span>' : '<span class="material-symbols-outlined" ;">light_mode</span> <span style="font-size: 32px;">|</span> <span class="material-icons">dark_mode</span>';
