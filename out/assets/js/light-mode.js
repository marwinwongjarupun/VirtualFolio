...
document.getElementById('toggle-theme-button').innerHTML = isLightMode ? '<span class="material-icons" style="font-size:20px;">light_mode</span> <span style="font-size: 30px;">|</span> <span class="material-symbols-outlined"style="font-size:20px;">dark_mode</span>' : '<span class="material-symbols-outlined" style="font-size:20px;">light_mode</span> <span style="font-size: 30px;">|</span> <span class="material-icons"style="font-size:20px;">dark_mode</span>';
